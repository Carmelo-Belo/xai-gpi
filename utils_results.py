...
def plot_train_val_loss(train_loss, val_loss, train_loss_noFS, val_loss_noFS, test_loss, test_loss_noFS):
    ...
    ax.plot(train_loss, label='FS mse', color='#1f77b4')
    ax.plot(val_loss, label='FS Val mse', color='#ff7f0e')
    ax.plot(train_loss_noFS, label='NoFS mse', color='#1f77b4', linestyle='--')
    ax.plot(val_loss_noFS, label='NoFS Val mse', color='#ff7f0e', linestyle='--')
    ax.axhline(y=test_loss, color='#2ca02c', linestyle='.', label='Test mse')
    ax.axhline(y=test_loss_noFS, color='#d62728', linestyle='.', label='NoFS Test mse')
