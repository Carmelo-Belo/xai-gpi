...
class CRO_SL:
    ...
    def optimize(self, save_data = True, update_data = True):
        ...
        while not self.stopping_condition(gen, real_time_start):
            ...
            if update_data:
                self.save_data(self.params.get("solution_file"), self.params.get("popul_file"), self.params.get("history_file"), self.params.get("prob_file"), self.params.get("indiv_file"))
