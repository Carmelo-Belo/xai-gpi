...
def main(basin, n_clusters, anomaly_clustering, res, first_year, last_year, remove_seasonality):
    ...
    if deseasonalize:
        dataset, target, seasonal = build_dataset(basin, cluster_variables, climate_indexes, cluster_path, indexes_path, target_path, first_year, last_year, deseasonalize, month_col=True)
